                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header" id="kt_modal_add_user_header">
                                        <!--begin::Modal title-->
                                        <h2 class="fw-bold">{{  __("admin.add").' '. __("admin.admin") }}</h2>
                                        <!--end::Modal title-->
                                        <!--begin::Close-->
                                    ...
                                    <div class="modal-body px-5 my-7">
                                        ...
                                        <form id="kt_modal_add_user_formm" id="kt_modal_add_user" class="form" action="#">
                                            ...
                                            <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                <div class="fv-row mb-10">
                                                    <div class="row g-9 mb-8">
                                                        <div class="col-md-6 fv-row">
                                                            ...
                                                            <input type="text" name="name"  class="form-control form-control-solid mb-3 mb-lg-0" placeholder="{{ __("admin.name") }}" />
                                                ...
                                                <div class="fv-row">
                                                    <!--begin::Label-->
                                                    <label class="fs-5 fw-bold form-label mb-2">{{ __("admin.roles") }}</label>
                                                    <!--end::Label-->
                                                    <!--begin::Table wrapper-->
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="d-flex">
                                                                                ...
                                                                                <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                                                    <input class="form-check-input permission-checkbox" type="checkbox" value="{{ $role->id }}" name="roles[]" />
                                                                                    <span class="form-check-label">{{ app()->getLocale() === 'ar' ? $role->name_ar : $role->name_en }}</span>
                                                                                </label>
                                                                                <!--end::Checkbox-->
                                                                            </div>
                                                                                @endforeach
                                           ...
                                           <form id="kt_modal_edit_form" class="form" action="#">
                                                ...
                                                <div class="d-flex flex-column scroll-y px-5 px-lg-10">
                                                    <div class="fv-row mb-7">
                                                        <label class="required fw-semibold fs-6 mb-2">{{ __("admin.name") }}</label>
                                                        <input type="text" name="name" id="editName" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="{{ __("admin.name") }}" />
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        $.each(response.data, function(key, item) {
                            ...
                            var roles = item.roles && item.roles.length > 0 ? item.roles.map(function(role) {
                                return role.name_ar;
                            }).join(', ') : "{{ __('admin.no_roles') }}";

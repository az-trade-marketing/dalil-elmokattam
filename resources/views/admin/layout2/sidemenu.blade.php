 ...
 class="menu-item menu-accordion {{ Request::segment(2) == 'admins' || Request::segment(2) == 'roles' ? 'hover show' : '' }}">
 <!--begin:Menu link-->
 <span
 class="menu-link {{ Request::segment(2) == 'admins' || Request::segment(2) == 'roles' ? 'active' : '' }}">
 <span class="menu-icon">
 ...
 <div data-kt-menu-trigger="click"
 class="menu-item menu-accordion {{ Request::segment(2) == 'zones' ? 'hover show' : '' }}">
 <!--begin:Menu link-->
 <span class="menu-link">
 <span class="menu-icon">
 <i class="ki-duotone ki-address-book fs-2">
 ...
 @can('Zone Read')
     <div class="menu-item">
     <a class="menu-link {{ Request::segment(2) == 'zones' ? 'active' : '' }}"
     href="{{ url('admin/zones') }}">
     <span class="menu-bullet">
     <span class="bullet bullet-dot"></span>
     </span>
 ...
 <div data-kt-menu-trigger="click"
 class="menu-item menu-accordion {{ Request::segment(2) == 'categories' || Request::segment(2) == 'features' || Request::segment(2) == 'tags' ? 'hover show' : '' }}">
 <!--begin:Menu link-->
 <span class="menu-link">
 <span class="menu-icon">
 <i class="ki-duotone ki-address-book fs-2">
 ...
 @can('tags Read')
     <div class="menu-item">
     <a class="menu-link {{ Request::segment(2) == 'tags' ? 'active' : '' }}"
     href="{{ url('admin/tags') }}">
     <span class="menu-bullet">
     <span class="bullet bullet-dot"></span>
     </span>
 ...
 @can('stores Read')
     <div data-kt-menu-trigger="click"
     class="menu-item menu-accordion {{ Request::segment(2) == 'stores' ? 'hover show' : '' }}">
     <!--begin:Menu link-->
     <span class="menu-link">
     <span class="menu-icon">
     <i class="ki-duotone ki-address-book fs-2">
     ...
     <div class="menu-sub menu-sub-accordion">
     <div class="menu-item">
     <a class="menu-link {{ Request::segment(2) == 'stores' && !Request::is('admin/stores/create') ? 'active' : '' }}"
     href="{{ url('admin/stores') }}">
     <span class="menu-bullet">
     <span class="bullet bullet-dot"></span>
     </span>
     <span class="menu-title">{{ __('admin.stores') }}</span>
     ...
     @can('stores Create')
         ...
         <div class="menu-item">
         <a class="menu-link {{ Request::segment(2) == 'joining-store' && !Request::is('admin/joining-store') ? 'active' : '' }}"
         href="{{ url('admin/joining-store') }}">
         <span class="menu-bullet">
         <span class="bullet bullet-dot"></span>
         </span>
         <span class="menu-title">{{ __('admin.joining-store') }}</span>
         </a>
         </div>
         <div class="menu-item">
         <a class="menu-link {{ Request::segment(2) == 'contacts-store' && !Request::is('admin/contacts-store') ? 'active' : '' }}"
         href="{{ url('admin/contacts-store') }}">
         <span class="menu-bullet">
         <span class="bullet bullet-dot"></span>
         </span>
         <span class="menu-title">{{ __('admin.contacts-store') }}</span>
         </a>
         </div>
     @endcan
     </div>
 ...
 <div data-kt-menu-trigger="click"
 class="menu-item menu-accordion {{ Request::segment(2) == 'push-notifications' ? 'hover show' : '' }}">
 <!--begin:Menu link-->
 <span class="menu-link">
 <span class="menu-icon">
 <i class="ki-duotone ki-address-book fs-2">
 ...
 @can('Zone Read')
     <div class="menu-item">
     <a class="menu-link {{ Request::segment(2) == 'push-notifications' ? 'active' : '' }}"
     href="{{ url('admin/push-notifications') }}">
     <span class="menu-bullet">
     <span class="bullet bullet-dot"></span>
     </span>
     <span class="menu-title">{{ __('admin.push_notification') }}</span>
 ...
 <div data-kt-menu-trigger="click"
 class="menu-item menu-accordion {{ Request::segment(2) == 'sliders' ? 'hover show' : '' }}">
 <!--begin:Menu link-->
 <span class="menu-link">
 <span class="menu-icon">
 <i class="ki-duotone ki-address-book fs-2">
 ...
 <div data-kt-menu-trigger="click"
 class="menu-item menu-accordion {{ Request::segment(2) == 'contacts' ? 'hover show' : '' }}">
 <!--begin:Menu link-->
 <span class="menu-link">
 <span class="menu-icon">
 <i class="ki-duotone ki-address-book fs-2">

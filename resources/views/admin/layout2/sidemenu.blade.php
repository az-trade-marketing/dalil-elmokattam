                ...
                <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true"  data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                    ...
                    <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                        ...
                        @if (!auth()->user()->hasRole('stores'))
                            ...
                            @can("stores Read")
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (Request::segment(2) == "opening-time" ) ? "hover show" :""  }}">
                                <!--begin:Menu link-->
                                <span class="menu-link">
                                    <span class="menu-icon">
                                        <i class="ki-duotone ki-address-book fs-2">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ (Request::segment(2) == "stores" ) ? "hover show" :""  }}">
                                ...
                                <div class="menu-sub menu-sub-accordion">
                                    <div class="menu-item">
                                        <a class="menu-link {{ (Request::segment(2) == "opening-time" && !Request::is('admin/opening-time/create')) ? "active" :""  }}" href="{{ url("admin/opening-time") }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">{{ __("admin.opening-time") }}</span>
                                    ...
                                    @can("stores Create")
                                        <div class="menu-item">
                                            <a class="menu-link {{ (Request::segment(2) == "opening-time" && Request::is('admin/opening-time/create')) ? "active" :""  }}" href="{{ url("admin/opening-time/create") }}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">{{ __("admin.add_opening-time") }}</span>
                                            </a>
                                        </div>
                                    @endcan
                                </div>

                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                @can('admin Create')
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        ...
                                        <i
                                            class="ki-duotone ki-plus fs-2"></i>{{ __('admin.add') . ' ' . __('admin.push_notifications') }}</button>
                                    <!--end::Add user-->
                                @endcan
                            </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    <div class="modal-content">
                                        <div class="modal-header" id="kt_modal_add_notification_header">
                                            <h2 class="fw-bold">{{ __('admin.add') . ' ' . __('admin.push_notification') }}
                                            </h2>
                                        ...
                                        <div class="modal-body px-5 my-7">
                                            ...
                                            <form id="kt_modal_add_notification_form" class="form" action="#">
                                                ...
                                                <div class="d-flex flex-column scroll-y px-5 px-lg-10"
                                                    id="kt_modal_add_notification_scroll" data-kt-scroll="true"
                                                    ...
                                                    <div class="fv-row mb-10">
                                                        <div class="row g-9 mb-8">
                                                            <div class="col-md-6 fv-row">
                                                                <label
                                                                    class="required fw-semibold fs-6 mb-2">{{ __('admin.title') }}</label>
                                                            ...
                                                            <div class="col-md-6 fv-row">
                                                                <label
                                                                    class="required fw-semibold fs-6 mb-2">{{ __('admin.message') }}</label>
                                                            ...
                                                            <div class="col-md-6 fv-row">
                                                                ...
                                                                <div class="invalid-feedback text-danger" id="error-image">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 fv-row">
                                                                <label
                                                                ...
                                                                <input type="url" name="link"
                                                                    class="form-control form-control-solid mb-3 mb-lg-0"
                                                                    placeholder="{{ __('admin. wwwwwwwwwwwwww') }}" />
                                                                <div class="invalid-feedback text-danger" id="error-link">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    <div class="modal-content">
                                        <div class="modal-header" id="kt_modal_edit_notification_header">
                                            <h2 class="fw-bold">
                                                {{ __('admin.edit') . ' ' . __('admin.push_notification') }}
                                            </h2>
                                                ...
                                                <div class="d-flex flex-column scroll-y px-5 px-lg-10">
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="text" name="title" id="editTitle"
                                                            class="form-control form-control-solid mb-3 mb-lg-0"
                                                            placeholder="{{ __('admin.title') }}" />
                                                        <div class="invalid-feedback text-danger" id="error-edit-title"
                                                            style="display: none;"></div>
                                                    </div>
                                                    <div class="fv-row mb-7">
                                                        <label
                                                            class="required fw-semibold fs-6 mb-2">{{ __('admin.message') }}</label>
                                                        <textarea name="message" id="editMessage" class="form-control form-control-solid mb-3 mb-lg-0"
                                                            placeholder="{{ __('admin.message') }}"></textarea>
                                                        <div class="invalid-feedback text-danger" id="error-edit-message"
                                                            style="display: none;"></div>
                                                    </div>
                                                    <div class="fv-row mb-7">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <div class="invalid-feedback text-danger" id="error-edit-link"
                                                            style="display: none;"></div>
                                                    </div>
                                                </div>
                                                <div class="text-center pt-10">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response.data, function(key, item) {
                            ...
                            var link = item.link ? '<a href="' + item.link +

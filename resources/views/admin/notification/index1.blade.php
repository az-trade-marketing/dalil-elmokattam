    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">{{ __("admin.push_notifications") }}</h1>
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--begin::Add push notification-->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_notification">
                                <i class="ki-duotone ki-plus fs-2"></i>{{ __("admin.add") . ' '.__("admin.push_notification") }}
                            </button>
                            <!--end::Add push notification-->
                            {{-- @endcan --}}
                        </div>
                        ...
                        <!-- Modal for edit -->
                        <div class="modal fade" id="kt_modal_edit_notification" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                <div class="modal-content">
                ...
                <div class="card-body py-4">
                    ...
                    <table class="table mb-0 data-table fs--1" id="myTable">
                        ...
                        <tbody class="list push_notification_table">
                        </tbody>
                      </table>
                    <!--end::Table-->
                </div>
        ...
        $(document).on('click', '.editButton', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#kt_modal_edit_notification').modal('show');
                },
                error: function(xhr) {
                ...
                success: function(response) {
                    ...
                    if (jsonResponse.status == 404) {
                        ...
                        swalWithBootstrapButtons.fire({
                            title: '{{__('admin.isDelete')}} ' + jsonResponse.title + ' !!?',
                            text: '{{__('admin.revet')}}',
                            icon: 'warning',
